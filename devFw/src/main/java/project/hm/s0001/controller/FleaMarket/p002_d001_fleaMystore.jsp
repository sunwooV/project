...
<!--참여자 추가창 -->
 <div class="messagepop pop2">
    ...
    <form method="post" id="new_message" action="/devFw/participantsInsert.do" enctype="multipart/form-data">    
         <p><label for="flea_name">아이디 검색&nbsp;</label><input type="text" size="30" name="memberid" id="memberid" /></p>
         <p><input type="submit" value="확인" name="commit2" id="message_submit2"/><a class="close2" href="/">Cancel</a></p>
     ...
     <div class="row-left">
      <aside class="artist-area">
   	...
   	<p><a href="/devFw/fleaCreateStoreApproval.do">플리마켓 관리자(임시)</a></p>
		             <p class="addmember">
		             	<a target="_blank" href="#" id="participants_add">
		             		<i class="fas fa-user-plus pa-5x"></i>
		             	</a>
		             </p>
