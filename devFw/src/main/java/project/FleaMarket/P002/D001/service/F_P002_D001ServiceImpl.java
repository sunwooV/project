...
@Service("F_P002_D001Service")
@Transactional(propagation = Propagation.REQUIRED)
public class F_P002_D001ServiceImpl implements F_P002_D001Service {
	@Autowired
	private F_P002_D001DAO d001DAO;

	@Override
	public List<F_P002_D001VO> searchList(Map<String, Object> searchMap) throws DataAccessException {
		List<F_P002_D001VO> list =  d001DAO.searchList(searchMap); 
		return list;
	}

	@Override
	public List<F_P002_D001VO> searchMod(Map<String, Object> searchMap) throws DataAccessException {
		List<F_P002_D001VO> list =  d001DAO.searchMod(searchMap);
		return list;
	}
