...
@Repository("F_P002_D001DAO")
public class F_P002_D001DAOImpl implements F_P002_D001DAO {
	@Autowired
	private SqlSession sqlSession;

	@Override
	public List<F_P002_D001VO> searchList(Map<String, Object> searchMap) throws DataAccessException {
		List<F_P002_D001VO> list = sqlSession.selectList("FleaMarket.p002_d001.searchList", searchMap);
	...
	public List<F_P002_D001VO> searchMod(Map<String, Object> searchMap) throws DataAccessException {
		List<F_P002_D001VO> list = sqlSession.selectList("hm.p0001.searchMod", searchMap);
		return list;
	}
