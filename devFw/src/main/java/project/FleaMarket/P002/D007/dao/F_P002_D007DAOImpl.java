...
public class F_P002_D007DAOImpl implements F_P002_D007DAO {
	...
	public List<F_P002_D007VO> searchMod(Map<String, Object> searchMap) throws DataAccessException {
		List<F_P002_D007VO> list = sqlSession.selectList("FleaMarket.p002_d007.searchMod", searchMap);
		return list;
	}
	...
	public void updateMember(Map<String, Object> datahMap) throws DataAccessException {
		sqlSession.update("FleaMarket.p002_d007.updateMember", datahMap);
	}

	@Override
	public void insertMember(Map<String, Object> datahMap) throws DataAccessException {
		sqlSession.update("FleaMarket.p002_d007.insertMember", datahMap);
	}

	@Override
	public void deleteMember(Map<String, Object> datahMap) throws DataAccessException {
		sqlSession.update("hm.F_P002_D007.deleteMember", datahMap);
	}
