package project.FleaMarket.P001.D004.dao;
...
@Repository("F_P001_D004DAO")
public class F_P001_D004DAOImpl implements F_P001_D004DAO {
	@Autowired
	private SqlSession sqlSession;

	@Override
	public List<F_P001_D004VO> searchList(Map<String, Object> searchMap) throws DataAccessException {
		List<F_P001_D004VO> list = sqlSession.selectList("FleaMarket.p001_d004.searchList", searchMap);
	...
	public void updateMember(Map<String, Object> datahMap) throws DataAccessException {
		sqlSession.update("FleaMarket.p001_d004.updateMember", datahMap);
	}
