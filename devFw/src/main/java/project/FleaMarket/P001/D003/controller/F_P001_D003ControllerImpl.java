...
public class F_P001_D003ControllerImpl implements F_P001_D003Controller {
	...
	@Override
	@RequestMapping(value = "/FleaMarket/P001/D003/JoinStart.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView JoinStart(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		*/
		ModelAndView mav = new ModelAndView("hm/p001_d003_JoinStart");
		return mav;
	}
	
	@Override
	@RequestMapping(value = "/FleaMarket/P001/D003/JoinForm.do", method = { RequestMethod.GET, RequestMethod.POST })
	...
	@Override
	@RequestMapping(value = "/FleaMarket/P001/D003/Join.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
