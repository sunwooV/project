...
<link rel="stylesheet" href="${contextPath }/resources/css/중고메인.css">
<!-- <script
		...
		<div class="row">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#home">주간
						TOP5</a></li>
				<li><a data-toggle="tab" href="#market">신제품</a></li>
				<li><a data-toggle="tab" href="#profile">오늘의 추천상품</a></li>
				<li><a data-toggle="tab" href="#flea">우수등급 스토어</a></li>
			</ul>
			<div class="tab-content">
				...
				<div id="flea" class="tab-pane fade">
					<div class="row">
						<div class="col-sm-3">
							<div class="thumbnail">
								<h4>중고상품</h4>
