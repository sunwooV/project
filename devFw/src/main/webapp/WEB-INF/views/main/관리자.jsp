...
<link rel="stylesheet" href="${contextPath }/resources/css/관리자.css">
<script
...
<body>
	...
	<!-- 메뉴사이드바랑 컨텐츠 ------------------------------------------------------------------------------------------------------------------------------------------>
	<div class="container" style="padding-bottom:92px; padding-left:75px;">
		<div id="myshopMain">
			<h1 style="padding-bottom: 27px; font-size: 32px;">ADMIN</h1>
			<div class="myshopMain_sub1">
				<div id="list">
					<h3>
						<a href="/myshop/order/list.html"><strong>플리마켓 자체검사</strong></a>
					</h3>
			...
			<div class="myshopMain_sub4">
				<div id="list">
					<h3>
						<a href="/myshop/mileage/historyList.html"><strong>판매자 등급 관리</strong></a>
					</h3>
					<p style="font-size: 11px;">
			...
			<div class="myshopMain_sub3">
				<div id="list">
					<h3>
						<a href="/myshop/deposits/historyList.html"><strong>포인트 관리</strong></a>
					</h3>
					<p style="font-size: 11px;">
			...
			<div class="myshopMain_sub4">
				<div id="list">
					<h3>
						<a href="/myshop/coupon/coupon.html"><strong>판매자 점수 관리</strong></a>
					</h3>
					<p style="font-size: 11px;">
			...
			<div class="myshopMain_sub5">
				<div id="list">
					<h3>
						<a href="/myshop/coupon/coupon.html"><strong>상품 배송 조회 리스트</strong></a>
					</h3>
					<p style="font-size: 11px;">
						<a href="/myshop/coupon/coupon.html">고객님이 보유하고 계신 쿠폰내역을
							보여드립니다.</a>
			...
			<div class="myshopMain_sub6">
				<div id="list">
					<h3>
						<a href="/myshop/coupon/coupon.html"><strong>플리마켓 개설 승인</strong></a>
					</h3>
					<p style="font-size: 11px;">
						<a href="/myshop/coupon/coupon.html">고객님이 보유하고 계신 쿠폰내역을
							보여드립니다.</a>
