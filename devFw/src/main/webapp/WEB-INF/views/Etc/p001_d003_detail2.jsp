	...
	<div class="container-fluid"
		...
		<div class="col-sm-2" id="col">
			...
			<div class="list-group">
				<a href="#" class="list-group-item list-group-item-action active">
					이용안내 </a> <a href="${contextPath}/detail1.do"
					class="list-group-item list-group-item-action">회사 소개 </a> <a
					href="${contextPath}/detail2.do"
					class="list-group-item list-group-item-action">고객보호서비스 </a> <a
					href="${contextPath}/detail3.do"
					class="list-group-item list-group-item-action"> ✔안전하게 이용하기 </a> <a
					href="${contextPath}/detail4.do"
					class="list-group-item list-group-item-action">이용방법 </a>
			</div>
		</div>
		<!-- 사이드바------------------------------------------------------------------------------------------------------------------------ -->
		<div class="col-sm-10" style="padding-left: 3%; font-size: 37px;">
			<h1 style="padding-bottom: 2%;">
				<span class="
glyphicon glyphicon-link"></span> 안전하게 이용하기
			</h1>
