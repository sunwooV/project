						...
						<div class="content">
							...
							<input type="button" onClick="abuttonClick('minus')" value="-">
									<input type="number" id="prod_amount" min="1"
										...
										style="width: 6%; height: auto; text-align: center;" value="">
							...
							<div id="deliveryTypeSection">
								...
								<div class="successNoticeBox" id="successNoticeBox"
									...
									<p id="SNBContent">
										장바구니 담기 혹은 수정 성공!<br>
										<br> <input type="button" id="noticeButton" value="창닫기"
											onClick="closeNotice();">&nbsp&nbsp&nbsp <input
											type="button" id="noticeButton" value="장바구니"
											onClick="moveToCart()">
									</p>
								</div>
