...
구매후기 왼쪽 .layout-split.half>*:first-child {
	margin-left: 0;
}
											...
											$
													.ajax({
														...
														success : function(
																responseData) {
															var test = document
																	.getElementById("prod_story_text").value = "";
...
<body>
	...
	<div class="row" id="flea">
		...
		<div class=".col-sm-8"
			style="width: 74%; border-left: 1px solid lightgray; padding-left: 2%;">
			<div class="row">

				<h3 class="ui_title__txt">
					<a href="/devFw/fleaReview.do">🎁판매 상품</a> <span class="rv_count"
						data-review="count"> (<em class="num">10</em>)
					</span>
					<form class="form-inline my-2 my-lg-0" id="search"
						name="searchform" method="POST"
						action="./fleaSearchProduct.do?flea_code=<%=flea_code%>"
						style="float: right;">
						<input class="form-control mr-sm-2" type="text" id="eachsearchbar"
							name="searchVal" value="" placeholder="검색어를 입력하세요♡"> <input
							type="submit" class="btn btn-dark" id="btneachsearch"
							value="Search"> <input type="hidden" id="division"
							name="division" value="reused">
					</form>
