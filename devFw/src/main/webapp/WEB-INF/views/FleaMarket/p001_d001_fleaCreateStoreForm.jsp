...
%>
    <div>
  안녕하세요. 국내 최대의 핸드메이드, 수공예 장터 서비스 마켓인유입니다.<br><br>

마켓인유에서는 손으로 직접 만든 핸드메이드/수공예 작품만 판매할 수 있으며,<br>
아래 정보를 작성해주시면 확인 후 '입점 안내' 메일을 보내드리겠습니다.<br><br>

단, 아트상품(공산품), 사입제품, 자체가 아닌 외주 공장 생산, DIY KIT 상품 등은 불가합니다.<br><br>
