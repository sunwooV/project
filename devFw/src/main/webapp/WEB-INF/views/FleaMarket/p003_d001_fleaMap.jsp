...
<body>
	<div class="container" style="padding-top: 3%; max-width: 60%;">
		<h1 style="padding-bottom: 27px; font-size: 32px;">
			<!-- <i class="fas fa-map-marked-alt"></i> 아이콘 변경하기 -->
	...
	<!-- 맵 표시 -->
		...
		//http://apis.map.kakao.com/web/sample/addr2coord/ (주소로 장소 표시하기)
		...
		<c:forEach var="addressList" items="${searchList}">
			...
			descriptionArray.push("${addressList.offline_location}");
				...
				//geocoder.addressSearch(addressArray[i], function(result, status, data){
			     ...
			     if (status === kakao.maps.services.Status.OK) {
			        ...
			        var infowindow = new kakao.maps.InfoWindow({
			            content: '<div style="width:150px;text-align:center;padding:6px 0;">${addressList.offline_location}</div>'
			        });
