	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="container"
			...
			<div class="w3-center w3-large w3-margin-top">
				<h2 style="margin-top: -8%; padding-bottom: 8%;">✍회원가입</h2>
			</div>
			<div>
				...
				<form id="joinForm" action="./join_member.do" method="post">
					...
					<p>
						<label>비밀번호 확인</label> <input class="w3-input" id="pw2"
							type="password" required>
					</p>
					<p>
					...
					<p>
						<label>닉네임</label> <input type="text" id="nickname"
							name="nickname" class="w3-input">
					</p>
					<p>
						<label>전화번호</label> <input type="text" id="phonenumber"
							name="phonenumber" class="w3-input" placeholder=" - 없이 입력해주세요.">
					</p>
					<p class="w3-center">
						<button type="submit" id="joinBtn"
							class="w3-button w3-block w3-black w3-ripple w3-margin-top w3-round">회원가입하기</button>
						<button type="button" onclick="history.go(-1);"
							class="w3-button w3-block w3-black w3-ripple w3-margin-top w3-margin-bottom w3-round">홈으로
							돌아가기</button>
					</p>
				</form>
			</div>
