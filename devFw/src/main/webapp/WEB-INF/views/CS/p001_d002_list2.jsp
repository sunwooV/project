	...
	<div class="container-fluid"
		...
		<div class="col-sm-10" id="csmain">
			...
			<div class="row" id="cscs1">
				<h2 style="font-size: 23px;padding-bottom: 2%;">🔔반품/교환/환불🔔</h2>
				<table class="table table-hover" style="width: 98%;">
					<tr>
						<th style="width: 78%;">제목</th>
					</tr>

					<c:forEach var="event" items="${refuList}" varStatus='refund'>
						<tr id=${refund.count } class="faq_open">
							<td>${event.title}</td>
						</tr>
						<tr style="display: none;" id="n${refund.count }">
