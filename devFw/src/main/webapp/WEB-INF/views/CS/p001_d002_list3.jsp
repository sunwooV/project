	...
	<div class="container-fluid"
		...
		<div class="col-sm-10" id="csmain">
			...
			<div class="row" id="cscs1">
				<h2 style="font-size: 23px;padding-bottom: 2%;">🔔배송문의🔔</h2>
				<table class="table table-hover" style="width: 98%;">
					<tr>
						<th style="width: 78%;">제목</th>
					</tr>

					<c:forEach var="event" items="${delivList}" varStatus='deliv'>
						<tr id=${deliv.count } class="faq_open">
							<td>${event.title}</td>
						</tr>
						<tr style="display: none;" id="n${deliv.count }">
