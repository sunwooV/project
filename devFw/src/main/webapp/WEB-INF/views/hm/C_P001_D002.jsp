...
//function frm_join() {
	...
	//frmPro.method = "post";
	//frmPro.action = "${contextPath}/Customers/p001/d001/loginCheck.do"; 
	//frmPro.submit();
//}
			...
			<div class="col-md-8 col-md-offset-2 col-sm-12">	
				<div class="form">
					...
					<form name="frm" method="post" action="${contextPath}/Customers/p001/d001/login.do">    
						...
						<h1><a href="http://localhost:8090/devFw/main.jsp"><img src="${contextPath }/resources/image/logo.jpg" width = 300px; height 150px;/></a></h1>

						<div class="input-group col-md-8 col-md-offset-2">
							<input type="ID" name="memberid" class="input ID" autocomplete="off">
							<label>ID</label>
						</div>
						...
						<div class="input-group">
							<div class="col-md-4 col-md-offset-4">
								...
								<button type="button" onClick="location.href='${contextPath}/Customers/p001/d001/joinInit.do'">
									JOIN
								</button>
